...
public class Hotspot : MonoBehaviour
{
    ...
    [SerializeField] private Texture _hotspotTexture;
    [SerializeField] private Texture _hotspotTextureNight;
    ...
    public float HotspotRotation { get => _hotspotRotation; set => _hotspotRotation = value; }
    public string Label { get => _label; set => _label = value; }
    public int Number { get => _number; set => _number = value; }
    public HotspotParameters[] HotspotParametersList { get => _HotspotParametersList; set => _HotspotParametersList = value; }
    public Transform HotspotRoot { get => _hotspotRoot; set => _hotspotRoot = value; }
    public EventTrigger SpriteTrigger { get => _spriteTrigger; set => _spriteTrigger = value; }
    public Texture HotspotTexture { get => _hotspotTexture; set => _hotspotTexture = value; }
    public Texture HotspotTextureNight { get => _hotspotTextureNight; set => _hotspotTextureNight = value; }
    public Color Color { get => _color; set => _color = value; }
    public Sprite MenuSprite { get => _menuSprite; set => _menuSprite = value; }
